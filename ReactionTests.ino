...
void rightTest (){
  ...
  Serial.print("Reaction Time Classification: ");
  if (reactionClassification(reactionTimeR)) {
    Serial.println("Faller");
  }else{
    Serial.println("Non-Faller");
  }
  
  Serial.print("Z-score");
  if (reactionClassification(reactionTimeR)) {
    Serial.println(zScore(reactionTimeR, fallerReactionMean, fallerReactionStddev ) );
  }else{
    Serial.println(zScore(reactionTimeR, nonFallerReactionMean, nonFallerReactionStddev ));
  }
}
...
void leftTest() {
  ...
  Serial.println(stddevL);
    ...
    Serial.print("Reaction Time Classification: ");
  if (reactionClassification(reactionTimeL)) {
    Serial.println("Faller");
  }else{
    Serial.println("Non-Faller");
  }
  ...
  Serial.print("Z-score");
  if (reactionClassification(reactionTimeL)) {
    Serial.println(zScore(reactionTimeL, fallerReactionMean, fallerReactionStddev ) );
  }else{
    Serial.println(zScore(reactionTimeL, nonFallerReactionMean, nonFallerReactionStddev ));
  }
}
